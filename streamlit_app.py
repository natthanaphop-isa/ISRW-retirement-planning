...
annual_expense = st.sidebar.number_input("ค่าใช้จ่ายหลังเกษียณต่อปี มูลค่าปัจจุบันไม่ต้องรวมเงินเฟ้อ (฿)", 0, 10000000, 500000, 1000)*(inflation_rate^(retirement_age - current_age))
