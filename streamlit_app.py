...
if selection1: 
    ...
    health_risk_expense = st.number_input("[HEALTH] ทุนค่าใช้จ่ายอื่น ๆ ด้านสุขภาพ ณ วันเกษียณ (฿)", 0, 10000000, 1000000, 100000)
else:
...
with col1:
    ...
    - [HEALTH] ทุนค่าใช้จ่ายอื่น ๆ ด้านสุขภาพ ณ วันเกษียณ: **฿{health_risk_expense:,.0f}**
